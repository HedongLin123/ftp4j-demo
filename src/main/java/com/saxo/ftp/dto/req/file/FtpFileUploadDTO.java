package com.saxo.ftp.dto.req.file;

import com.saxo.ftp.dto.req.IBaseRequest;
...
/**
 * @Description 文件上传参数实体
 * @Author donglin.he
 * @Date 2022/11/25 14:44
 */

@Data
@ApiModel(description = "文件上传参数实体")
public class FtpFileUploadDTO implements IBaseRequest {
    ...
    /**
     * 文件上传到FTP的目录路径，也就是上传到哪个目录
     */
    @ApiModelProperty(value = "文件上传到FTP的目录路径，也就是上传到哪个目录（不需要带ftp服务器的根路径）", required = true)
